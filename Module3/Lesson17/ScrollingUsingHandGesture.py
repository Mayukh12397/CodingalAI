...
# For constant values, name their variables in captial letters.
...
def detect_gesture(landmarks, handedness):
    ...
    for tip in tips:
        if landmarks.landmark[tip].y < landmarks.landmark[tip - 2].y: # the difference between tip and pip is 2, thats why we subtracted 2 from tip , so we could subtract the  y value of pip from y value of tip.
            fingers.append(1)
    # Check thumb
