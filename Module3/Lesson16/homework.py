...
from pycaw.pycaw import AudioUtilities, IAudioEndpointVolume # This helps connect python code to the windows system.
import screen_brightness_control as sbc # to change the system's brightness from python.


Hands = mp.solutions.hands
hands = Hands.Hands(min_detection_confidence=0.75, min_tracking_confidence=0.75)
    ...
    if res.multi_hand_landmarks and res.multi_handedness:
        for i, hand in enumerate(res.multi_hand_landmarks):
            ...
            if label == "Left":  # real RIGHT hand -> volume (frame is flipped)
                ...
                cv2.rectangle(img, (50,150), (85,400), (255,0,0), 2); cv2.rectangle(img, (50,bar), (90,400), (255,0,0), cv2.FILLED)
                ...
                cv2.rectangle(img, (x1,150), (x2,400), (0,255,0), 2); cv2.rectangle(img, (x1,bar), (x2,300), (0,255,0), cv2.FILLED)
                cv2.putText(img, f"{b}%", (w-110,450), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 4)
