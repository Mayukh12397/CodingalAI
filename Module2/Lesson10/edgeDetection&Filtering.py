...
def interactive_edge_detection(image_path):
    ...
    image = cv2.imread('picture.jpg') # 'picture.jpg' is parameter passed in function call interactive_edge_detection, just used to load the image.
    if image is None:
...
# interactive_edge_detection('picture.jpg')
interactive_edge_detection('Module2/Lesson10/picture.jpg') # this can be used when an image or any files is stored in a specific folder.
